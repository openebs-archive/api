...
(
  ...
  #cd $(dirname "${0}")
  go get -d k8s.io/code-generator@v0.25.0
  cd "$(go env GOPATH)/pkg/mod/k8s.io/code-generator@v0.25.0"
...
deepcopy_inputs=(
  ...
  pkg/internalapis/apis/openebs.io \
)
...
defaulter_inputs=(
  pkg/internalapis/apis/cstor/v1 \
  pkg/internalapis/apis/openebs.io/v1alpha1 \
)
