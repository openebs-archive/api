...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CapacityDetails) DeepCopyInto(out *CapacityDetails) {
	*out = *in
	out.LogicalUsed = in.LogicalUsed.DeepCopy()
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CapacityDetails.
func (in *CapacityDetails) DeepCopy() *CapacityDetails {
	if in == nil {
		return nil
	}
	out := new(CapacityDetails)
	in.DeepCopyInto(out)
	return out
}
