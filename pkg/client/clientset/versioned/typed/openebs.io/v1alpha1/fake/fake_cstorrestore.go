...
var cstorrestoresResource = v1alpha1.SchemeGroupVersion.WithResource("cstorrestores")

var cstorrestoresKind = v1alpha1.SchemeGroupVersion.WithKind("CStorRestore")
...
func (c *FakeCStorRestores) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(cstorrestoresResource, c.ns, name, opts), &v1alpha1.CStorRestore{})
