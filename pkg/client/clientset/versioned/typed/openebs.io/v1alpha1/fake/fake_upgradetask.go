...
var upgradetasksResource = v1alpha1.SchemeGroupVersion.WithResource("upgradetasks")

var upgradetasksKind = v1alpha1.SchemeGroupVersion.WithKind("UpgradeTask")
...
func (c *FakeUpgradeTasks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(upgradetasksResource, c.ns, name, opts), &v1alpha1.UpgradeTask{})
